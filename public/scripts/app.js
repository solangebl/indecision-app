...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleDeleteOption(toRemove) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Options, { options: this.state.options, handleDelete: this.handleDeleteOptions, handleDeleteOption: this.handleDeleteOption }),
